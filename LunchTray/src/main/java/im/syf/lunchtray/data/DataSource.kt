package im.syf.lunchtray.data

import im.syf.lunchtray.constants.ItemType
import im.syf.lunchtray.model.MenuItem
...
object DataSource {
    ...
    val menuItems: Map<String, MenuItem> = mapOf(
        ...
        "pasta" to MenuItem(
            name = "Mushroom Pasta",
            description = "Penne pasta, mushrooms, basil, with plum tomatoes cooked in " +
